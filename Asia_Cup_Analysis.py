...
def validate_country(country):
    country_check = 0
    with open(r"C:\Users\mailt\Desktop\asiacup.csv", "r") as fl:
        x = fl.readline()
...
with open(r"C:\Users\mailt\Desktop\asiacup.csv", 'r') as file:
...
if sel ==1:
    ...
    while chk == 0:
        ...
        if ct_validation == 0:
            ...
            plt.savefig("%s %s analyis.jpg"%(ct.lower(),inn.lower()), bbox_inches="tight")
            plt.show()
            chk=1;break;
